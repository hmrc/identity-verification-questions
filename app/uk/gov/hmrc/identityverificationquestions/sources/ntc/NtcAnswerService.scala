...
import uk.gov.hmrc.identityverificationquestions.models.TaxCredits.{Amount, BankAccount}
...
class NtcAnswerService @Inject()(ntcAnswerConnector: NtcAnswerConnector, as: AuditService)(implicit override val appConfig: AppConfig, ec: ExecutionContext)
  ...
  override def connector: AnswerConnector[QuestionResult] = ntcAnswerConnector

  override def supportedQuestions: Seq[QuestionKey] = Seq(BankAccount, Amount)
