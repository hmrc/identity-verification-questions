...
@Singleton
class EmpRefAnswerService @Inject()(empRefAnswerConnector: EmpRefAnswerConnector, as: AuditService)(implicit override val appConfig: AppConfig, ec: ExecutionContext)
  ...
  override def connector: AnswerConnector[QuestionResult] = empRefAnswerConnector

  override def supportedQuestions: Seq[QuestionKey] = Seq(DateOfPayment, AmountOfPayment)
